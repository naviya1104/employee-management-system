    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                print("Employee ID:", self.var_emp_id.get())
                print("Name:", self.var_name.get())
                print("Email:", self.var_email.get())
                print("Gender:", self.var_gender.get())
                print("Contact:", self.var_contact.get())
                print("DOB:", self.var_dob.get())
                print("DOJ:", self.var_doj.get())
                print("Designation:", self.var_pass.get())
                print("User Type:", self.var_utype.get())
                print("Address:", self.txt_address.get('1.0', END))
