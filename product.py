    ...
    def add(self):
        ...
        try:
            if self.var_cat.get()=="Select" or self.var_cat.get()=="Empty" or self.var_sup.get()=="Select" or self.var_name.get()=="":
                ...
                print("Category:", self.var_cat.get())
                print("Supplier:", self.var_sup.get())
                print("Name:", self.var_name.get())
                print("Price:", self.var_price.get())
                print("Quantity:", self.var_qty.get())
                print("Status:", self.var_status.get())
                ...
                con.commit()
                messagebox.showinfo("Success","Product Addded Successfully",parent=self.root)
                self.show()
        ...
        try:
            if self.var_pid.get() == "":
                ...
                if row is None:
                    ...
                    print("Product ID:", self.var_pid.get())
                    print("Category:", self.var_cat.get())
                    print("Supplier:", self.var_sup.get())
                    print("Name:", self.var_name.get())
                    print("Price:", self.var_price.get())
