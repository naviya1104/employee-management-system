    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                print("Invoice No.:", self.var_sup_invoice.get())
                print("Name:", self.var_name.get())
                print("Contact:", self.var_contact.get())
                print("Description:")
                print(self.txt_desc.get('1.0', END))
                ...
                con.commit()
                messagebox.showinfo("Success","Supplier Addded Successfully",parent=self.root)
                self.show()
            ...
            if self.var_sup_invoice.get() == "":
                ...
                if row == None:
                    ...
                    if op == True:
                        ...
                        # Print the details of the deleted supplier in the terminal
                        print("Deleted Supplier Details:")
                        print("Invoice No.:", row[0])
                        print("Name:", row[1])
                        print("Contact:", row[2])
                        print("Description:")
                        print(row[3])
